...
export default function HtmlEnDeCode(){
    ...
    return (
        <>
            <Grid container spacing={3}>
                <Grid item md={12}>
                    <Typography variant="h4" component="h2">HTML Encode & Decode</Typography>
                ...
                <Grid item md={12}>
                    <ButtonGroup variant="outlined">
                        <Button variant="contained" onClick={handleEncode} startIcon={<CodeOff />}>Encode</Button>
                        <Button variant="contained" onClick={handleDecode} startIcon={<Code />}>Decode</Button>
                    </ButtonGroup>
